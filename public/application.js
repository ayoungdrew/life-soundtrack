...
var config = {
  apiOrigins: {
    ...
    production: 'https://life-soundtrack-api.herokuapp.com'
  }
};
...
var authEvent = __webpack_require__(13);
...
var addHandlers = function addHandlers() {
  var originalModal = $('#sign-up-inner').clone();
  ...
  $('#create-song').on('submit', function (event) {
    ...
    if (data.song.name === '' || data.song.artist === '') {
      ...
      api.createSong(data).then(ui.createSongSuccess).catch(function () {
  ...
  $('#get-all-phases').on('submit', function (event) {
    ...
    api.getPhases().then(ui.getPhasesSuccess).catch(ui.getPhasesFailure);
  });
  ...
  $('body').on('click', '.get-phase-button', function (event) {
    ...
    api.getPhase($(this).attr('data-id')).then(ui.getPhaseSuccess);
  });
  ...
  $('body').on('submit', '.edit-phase', function (event) {
    ...
    api.editPhase($(this).attr('data-id'), data).then(ui.editPhaseSuccess(data)).catch(ui.editPhaseFailure);
  ...
  $('#create-phase').on('submit', function (event) {
    ...
    if (data.phase.name === '' || data.phase.start_date === '' || data.phase.end_date === '') {
      ...
      api.createPhase(data).then(ui.createPhaseSuccess).catch(ui.createPhaseFailure);
    }
  });
  ...
  $('#create-favorite-song').on('submit', function (event) {
    ...
    if (Object.values(data.favorite_song).some(isEmpty)) {
      ...
      api.getSongs().then(ui.getSongsSuccess).catch(ui.getSongsFailure).then(data.favorite_song.user_id = store.user.id).then(function () {
        for (var i = 0; i < store.songs.length; i++) {
        ...
        api.createFavoriteSong(data).then(ui.createFavoriteSongSuccess).catch(ui.createFavoriteSongFailure);
      });
    }
  });
  ...
  $('body').on('submit', '.edit-favorite-song', function (event) {
    ...
    api.editFavoriteSong($(this).attr('data-id'), data).then(ui.editFavoriteSongSuccess).catch(ui.editFavoriteSongFailure);
    // $(this).closest('form').find('input[type=text], textarea').val('')
  });
...
var getPhase = function getPhase(dataId) {
  // this is the POST verb
  return $.ajax({
...
var createPhase = function createPhase(data) {
  // this is the POST verb
  return $.ajax({
    url: config.apiOrigin + '/phases',
    method: 'POST',
...
var editPhase = function editPhase(dataId, data) {
  // this is the POST verb
  return $.ajax({
    url: config.apiOrigin + '/phases/' + dataId,
    method: 'PATCH',
...
var deletePhase = function deletePhase(dataId) {
  // this is the POST verb
  return $.ajax({
    url: config.apiOrigin + '/phases/' + dataId,
    method: 'DELETE',
...
var createSong = function createSong(data) {
  // this is the POST verb
  return $.ajax({
    url: config.apiOrigin + '/songs',
    method: 'POST',
...
var createSongGetSongs = function createSongGetSongs(data) {
  // this is the POST verb
  return $.ajax({
    url: config.apiOrigin + '/songs',
    method: 'POST',
...
var createFavoriteSong = function createFavoriteSong(data) {
  // this is the POST verb
  return $.ajax({
    url: config.apiOrigin + '/favorite_songs',
    method: 'POST',
...
var editFavoriteSong = function editFavoriteSong(dataId, data) {
  // this is the POST verb
  return $.ajax({
...
var deleteFavoriteSong = function deleteFavoriteSong(dataId) {
  // this is the POST verb
  return $.ajax({
    url: config.apiOrigin + '/favorite_songs/' + dataId,
    method: 'DELETE',
...
module.exports = {
  ...
  createFavoriteSong: createFavoriteSong,
  editFavoriteSong: editFavoriteSong,
  createSongGetSongs: createSongGetSongs,
  getPhase: getPhase,
  getPhases: getPhases,
...
var store = __webpack_require__(3);
var showPhasesTemplate = __webpack_require__(17);
var showPhaseTemplate = __webpack_require__(34);
...
var signInSuccess = function signInSuccess(data) {
  $('#greeting-text, #sign-out, #get-songs, #get-all-phases, #phases-content, #get-phase, #create-phase, #create-song, #create-favorite-song, #profile-button, #phases-content').css({
    'display': 'block'
  });
...
var getSongsFailure = function getSongsFailure(error) {
  console.error(error);
};

var fillEmptyForms = function fillEmptyForms() {
  $('#alert-modal').modal('toggle');
  $('#alert-modal-message').text('Fill out the form!');
};

var createSongSuccess = function createSongSuccess(data) {
  // console.log(data)
...
var createSongFailure = function createSongFailure(error) {
  console.error(error);
  $('#create-song').trigger('reset');
  $('#alert-modal').modal('toggle');
...
var getPhasesSuccess = function getPhasesSuccess(data) {
  ...
  if (data.phases.length === 0) {
    ...
    var showPhasesHtml = showPhasesTemplate({ phases: store.phases });
...
var getPhaseSuccess = function getPhaseSuccess(data) {
  // console.log('Phase is...', data)
  store.favorite_songs = data.favorite_songs;
  var showPhaseHtml = showPhaseTemplate({ favorite_songs: store.favorite_songs });
  // we can use `.html` instead of `.append` to get around the need for a
  // clear books button
...
//   $('.phases-content').html(showPhasesHtml)
// }
var createPhaseSuccess = function createPhaseSuccess(data) {
...
var createPhaseFailure = function createPhaseFailure() {
  $('#alert-modal').modal('toggle');
  $('#alert-modal-message').text('Failed to create new phase :(');
  $('#create-phase').trigger('reset');
};

var editPhaseSuccess = function editPhaseSuccess() {
  $('.edit-phase-modal-message').html('Edits made! :D').addClass('successMessage');
  // console.log('Edited phase!')
};

var editPhaseFailure = function editPhaseFailure() {
  // console.log('Edited Phase!')
};

var clearPhases = function clearPhases() {
  $('.phases-content').empty();
};

var getPhasesFailure = function getPhasesFailure(error) {
  console.error(error);
};

var getFavoriteSongsSuccess = function getFavoriteSongsSuccess(data) {
  // console.log('you rock')
};

var getFavoriteSongsFailure = function getFavoriteSongsFailure(error) {
  console.error(error);
};

var createFavoriteSongSuccess = function createFavoriteSongSuccess(data) {
  $('#create-favorite-song').trigger('reset');
  $('#alert-modal').modal('toggle');
  $('#alert-modal-message').text('Your story was added!');
};

var createFavoriteSongFailure = function createFavoriteSongFailure() {
  $('#alert-modal').modal('toggle');
  $('#alert-modal-message').text('Failed :( Add the song to the database first!');
};

var editFavoriteSongSuccess = function editFavoriteSongSuccess() {
  $('.edit-favorite-song-modal-message').html('Edits made! :D').addClass('successMessage');
  // console.log('Edited favorite song!')
};

var editFavoriteSongFailure = function editFavoriteSongFailure() {
  // console.log('Edited favorite song!')
};
...
module.exports = {
  ...
  fillEmptyForms: fillEmptyForms,
  createSongSuccess: createSongSuccess,
  createSongFailure: createSongFailure,
  getFavoriteSongsSuccess: getFavoriteSongsSuccess,
  getFavoriteSongsFailure: getFavoriteSongsFailure,
  createFavoriteSongSuccess: createFavoriteSongSuccess,
  createFavoriteSongFailure: createFavoriteSongFailure,
  editFavoriteSongSuccess: editFavoriteSongSuccess,
  editFavoriteSongFailure: editFavoriteSongFailure,
  getPhasesSuccess: getPhasesSuccess,
  getPhasesFailure: getPhasesFailure,
  getPhaseSuccess: getPhaseSuccess,
  createPhaseSuccess: createPhaseSuccess,
  createPhaseFailure: createPhaseFailure,
  editPhaseSuccess: editPhaseSuccess,
  editPhaseFailure: editPhaseFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n <!-- Developers, why are we using data-id and not just id? -->\n<div style=\"padding: 30px;\">\n      <h1 data-id=\""
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + " -->\n          <!-- userid: "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.user : stack1)) != null ? stack1.id : stack1), depth0))
    + " -->\n      </h1>\n      <h3 style=\"margin-top: 0;\">\n        "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.start_date : stack1), depth0))
    + " - "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.end_date : stack1), depth0))
    + "\n      </h3>\n<p>\n  <a href=\"#\" class=\"get-phase-button listing-edit\" data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + ">\n  View this phase\n</a>\n|\n      <!-- <button type=\"button\" class=\"get-phase-button\" data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + ">\n        View Phase\n      </button>\n| -->\n\n  <!-- Edit Phase Modal BUTTON -->\n    <a href=\"#\"class=\"listing-edit\" data-toggle=\"modal\" data-target=\"#edit-phase-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "-modal\">\n    Edit this phase\n  </a>\n|\n  <a href=\"#\"class=\"listing-edit phase-delete-button\" data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + ">\n  Delete this phase\n</a>\n  <!-- <form class=\"phase-modal-button\">\n    <button type=\"button\" class=\"btn btn-primary spacer20\" data-toggle=\"modal\" data-target=\"#edit-phase-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "-modal\">\n    Edit this phase\n  </button>\n  </form> -->\n</p>\n</div>\n  <!-- Edit Phase Modal -->\n      <div class=\"modal fade edit-phase-modal\" id=\"edit-phase-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "-modal\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\">\n        <div class=\"modal-dialog\" id=\"edit-phase-inner\" role=\"document\">\n          <div class=\"modal-content\">\n            <div class=\"modal-header\">\n              <h5 class=\"modal-title\" id=\"exampleModalLabel\">Edit Phase Entry</h5>\n              <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n                <span aria-hidden=\"true\">&times;</span>\n              </button>\n            </div>\n            <div class=\"modal-body\">\n              <form class=\"form-group edit-phase\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n                <fieldset id=\"edit-phase-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "-form\">\n                  <div>\n                    <h2 class=\"phase-editor-name\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "</h2>\n                    <h3 class=\"phase-editor-start-date\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.start_date : stack1), depth0))
    + " through "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.end_date : stack1), depth0))
    + "</h3>\n                  <div class=\"form-group col-sm-12\">\n                    <label for=\"exampleInputEmail1\">Name</label>\n                    <input type=\"text\" name=\"phase[name]\" class=\"form-control\" aria-describedby=\"emailHelp\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "\">\n                  </div>\n                  <div class=\"form-group col-sm-6\">\n                    <label for=\"exampleInputPassword\">Phase Start Date</label>\n                    <input type=\"text\" name=\"phase[start_date]\" class=\"form-control\" aria-describedby=\"emailHelp\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.start_date : stack1), depth0))
    + "\">\n                  </div>\n                  <div class=\"form-group col-sm-6\">\n                    <label for=\"exampleInputPassword\">Phase End Date</label>\n                    <input type=\"text\" name=\"phase[end_date]\" class=\"form-control\" aria-describedby=\"emailHelp\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.end_date : stack1), depth0))
    + "\">\n                  </div>\n                </div>\n                </fieldset>\n                <div class=\"col-sm-12 edit-phase-modal-message\" id=\"edit-phase-modal-message\"></div>\n                <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Close</button>\n                <button type=\"submit\" class=\"btn btn-primary submit-phase-edits\">Edit</button>\n            </form>\n            </div>\n          </div>\n        </div>\n      </div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.phases : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n <!-- Developers, why are we using data-id and not just id? -->\n<div class=\"col-sm-4\" style=\"min-height: 240px; padding: 30px;\">\n\n      <h2 class=\"song-listing\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n          \""
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.song : stack1)) != null ? stack1.name : stack1), depth0))
    + "\"\n      </h2>\n      <h3 class =\"song-artist-listing\">\n          "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.song : stack1)) != null ? stack1.artist : stack1), depth0))
    + "\n          <!-- "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.songs : stack1), depth0))
    + " -->\n      </h3>\n        <h4 class=\"song-artist-story-date\">The year was "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.story_date : stack1), depth0))
    + "...</h4>\n        <hr>\n        <p>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.story : stack1), depth0))
    + "</p>\n\n\n  <!-- Edit Favorite Song Modal BUTTON -->\n  <a href=\"#\" data-target=\"#edit-favorite-song-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "-modal\" class=\"listing-edit\" data-toggle=\"modal\">\n    Edit this story\n  </a>\n  <!-- <button type=\"button\" class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#edit-favorite-song-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "-modal\">\n    Edit this story\n  </button> -->\n\n  <!-- DELETE Favorite Song Modal BUTTON -->\n  |\n  <a href=\"#\" class=\"listing-edit favorite-song-delete-button\" data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + ">\n    Remove\n  </a>\n\n  <!-- <button type=\"button\" class=\"btn btn-primary favorite-song-delete-button\" data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + ">\n    Remove\n  </button> -->\n</div>\n\n  <!-- Edit Favorite Song Modal -->\n      <div class=\"modal fade edit-favorite-song-modal\" id=\"edit-favorite-song-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "-modal\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\">\n        <div class=\"modal-dialog\" id=\"edit-favorite-song-inner\" role=\"document\">\n          <div class=\"modal-content\">\n            <div class=\"modal-header\">\n              <h5 class=\"modal-title\" id=\"exampleModalLabel\">Edit Favorite Song Entry</h5>\n              <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n                <span aria-hidden=\"true\">&times;</span>\n              </button>\n            </div>\n            <div class=\"modal-body\">\n              <form class=\"form-group edit-favorite-song\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n                <fieldset id=\"edit-favorite-song-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "-form\">\n                  <div>\n                    <h2>\""
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.song : stack1)) != null ? stack1.name : stack1), depth0))
    + "\"</h2>\n                    <h3>"
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.song : stack1)) != null ? stack1.artist : stack1), depth0))
    + "</h3>\n                  <div class=\"form-group col-sm-6\">\n                    <label for=\"exampleInputPassword\">Story Date</label>\n                    <input type=\"text\" name=\"favorite_song[story_date]\" class=\"form-control\" aria-describedby=\"emailHelp\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.story_date : stack1), depth0))
    + "\">\n                  </div>\n                  <div class=\"form-group col-sm-12\">\n                    <label for=\"exampleInputEmail1\">Story</label>\n                    <input type=\"text\" name=\"favorite_song[story]\" class=\"form-control\" aria-describedby=\"emailHelp\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.story : stack1), depth0))
    + "\">\n                    <small class=\"form-text text-muted\">Tell us your deepest darkest secrets. And your thoughts on this songs too.</small>\n                  </div>\n                </div>\n                </fieldset>\n                <div id=\"edit-favorite-song-modal-message\" class=\"col-sm-12 edit-favorite-song-modal-message\"></div>\n                <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Close</button>\n                <button type=\"submit\" class=\"btn btn-primary submit-favorite-song-edits\">Edit</button>\n            </form>\n            </div>\n          </div>\n        </div>\n      </div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.favorite_songs : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
